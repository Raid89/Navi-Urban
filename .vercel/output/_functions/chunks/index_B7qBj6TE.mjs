...
import 'piccolore';
import { m as maybeRenderHead, r as renderTemplate, h as addAttribute, l as renderComponent } from './entrypoint_DJpBiLpZ.mjs';
import { r as renderScript, $ as $$BaseLayout, a as $$Navbar, b as $$SiteFooter } from './SiteFooter_D0yC0Wcp.mjs';
import 'clsx';
import { g as getProductImageUrl, b as getPromotions, c as getVisibleProducts } from './catalog_CxFMU3QK.mjs';
...
Descubre la nueva coleccion de zapatos urbanos y deportivos. Explora promociones activas
      y filtra por precio en nuestro catalogo completo.
</p> <div class="hero-cta"> <a href="#catalogo" class="btn btn-main">Ver Catalogo</a> </div> </div> <aside class="hero-panel reveal stagger-1"> <h2>Semana Urban Drop</h2> <p>
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let products = [];
  try {
    [promotions, products] = await Promise.all([getPromotions(), getVisibleProducts()]);
  } catch (error) {
    console.error("Failed to load home catalog data.", error);
  }
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "NAVI URBAN | Zapatos Urbanos", "description": "NAVI URBAN: landing oficial de zapatos urbanos y deportivos con promociones y catalogo interactivo." }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Navbar", $$Navbar, {})} ${renderComponent($$result2, "HeroSection", $$HeroSection, {})} ${renderComponent($$result2, "PromotionsSection", $$PromotionsSection, { "promotions": promotions })} ${renderComponent($$result2, "CatalogSection", $$CatalogSection, { "products": products })} ${renderComponent($$result2, "SiteFooter", $$SiteFooter, {})} ` })}`;
